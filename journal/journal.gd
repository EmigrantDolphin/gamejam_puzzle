...
var journalIntro = 'This is the girls journal. It says "Dream Journal" on the cover. Her parents [i]did[/i] mentioned that she was into dream analysis. Maybe there is something here. The last dream reads...'
